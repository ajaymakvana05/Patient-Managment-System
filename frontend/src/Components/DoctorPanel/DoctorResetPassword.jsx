        ...
        <div className="w-full max-w-md p-8 mx-auto bg-white border border-gray-200 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4 relative">
              ...
              <label
                htmlFor="newPassword"
                className="absolute left-2.5 top-4 z-10 origin-[0] -translate-y-4 scale-75 transform bg-white px-2 text-sm font-medium text-gray-500 duration-500 peer-placeholder-shown:top-4 peer-placeholder-shown:scale-100 peer-placeholder-shown:text-gray-400 peer-focus:top-2 peer-focus:scale-75 peer-focus:text-blue"
              >
                New Password*
              </label>
              {errors.newPassword && (
