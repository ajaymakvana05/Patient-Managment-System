          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4 relative">
              <input
                ...
                className={`peer block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent border rounded-lg focus:outline-none focus:border-blue-600 focus:ring-0 ${errors.email ? "border-red" : "border-gray-300"
                  }`}
              />
              <label
                htmlFor="email"
            ...
            <div className="mb-4 relative">
              <input
                ...
                onChange={handleChange}
                className={`peer block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent border rounded-lg focus:outline-none focus:border-blue-600 focus:ring-0 ${errors.password ? "border-red" : "border-gray-300"
                  }`}
              />
              <label
                htmlFor="password"
